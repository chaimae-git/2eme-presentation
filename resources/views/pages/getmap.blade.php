...
{{--<!--            --><?php //$decode_json = echo ($geo[0]->geojson) ?>--}}
{{--            --}}{{--        {{dd(print_r($decode_json->coordinates))}}--}}

{{--        var crs = <?php echo json_encode($decode_json->crs)?>;--}}
{{--        var type = "{{$decode_json->type}}";--}}
{{--        var coordinates = <?php echo json_encode($decode_json->coordinates)?>;--}}
{{--        //var features = <?php echo json_encode($geo[0])?>--}}
{{--        alert(features);--}}
